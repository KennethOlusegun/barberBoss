 ...
 */
export const ThrottleStrict = () => NestThrottle({ strict: { ttl: 60000, limit: 5 } });

/**
 * Rate limiting moderado para operações comuns
 * 30 requisições por minuto
 */
export const ThrottleModerate = () => NestThrottle({ moderate: { ttl: 60000, limit: 30 } });

/**
 * Rate limiting relaxado para leitura
 * 100 requisições por minuto
 */
export const ThrottleRelaxed = () => NestThrottle({ relaxed: { ttl: 60000, limit: 100 } });
