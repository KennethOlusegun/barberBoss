...
export const ThrottleStrict = () =>
  NestThrottle([{ name: 'strict', ttl: 60000, limit: 5 }]);
...
export const ThrottleModerate = () =>
  NestThrottle([{ name: 'moderate', ttl: 60000, limit: 30 }]);
...
export const ThrottleRelaxed = () =>
  NestThrottle([{ name: 'relaxed', ttl: 60000, limit: 100 }]);
